<div class="support-area">
    <div class="container">
        <div class="support-content">
            ...
            <p>En tant qu'entreprise de développement de logiciels, de site web, d'application web/mobile, nous combinons le meilleur des deux mondes. Nous avons la concentration et la rapidité des petites et moyennes entreprises d'externalisation informatique ainsi que l'évolutivité et l'expertise des grandes.</p>
            <span>Baba NGOM, CEO chez AmeenTECH</span>
        </div>
    </div>
