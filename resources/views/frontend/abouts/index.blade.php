        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single-features">
                    <a href="services-details.html"><img src="{{asset('frontend/assets/images/features/features-1.png')}}" alt="image"></a>
                    <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-features">
                    <a href="services-details.html"><img src="{{asset('frontend/assets/images/features/features-2.png')}}" alt="image"></a>
                    <h3>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-features">
                    <a href="services-details.html"><img src="{{asset('frontend/assets/images/features/features-3.png')}}" alt="image"></a>
                    <h3>
...
<div class="about-area">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-image" data-speed="0.02" data-revert="true">
                    <img src="{{asset('frontend/assets/images/about/about.png')}}" alt="image">
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="about-item">
                    <div class="about-content">
                        <div class="tag">
                            <img src="{{asset('frontend/assets/images/about/tag-icon.png')}}" alt="image">
                        </div>
                    ...
                    <div class="about-inner-content">
                        <img src="{{asset('frontend/assets/images/about/img1.png')}}" alt="image">
                    ...
                    <div class="about-inner-content">
                        <img src="{{asset('frontend/assets/images/about/img2.png')}}" alt="image">
                    ...
                    <div class="about-inner-content">
                        <img src="{{asset('frontend/assets/images/about/img3.png')}}" alt="image">
    ...
    <div class="about-shape-1" data-speed="0.08" data-revert="true">
        <img src="{{asset('frontend/assets/images/about/shape-1.png')}}" alt="image">
    </div>
    <div class="about-shape-2" data-speed="0.08" data-revert="true">
        <img src="{{asset('frontend/assets/images/about/shape-2.png')}}" alt="image">
    </div>
    <div class="about-shape-3" data-speed="0.08" data-revert="true">
        <img src="{{asset('frontend/assets/images/about/shape-3.png')}}" alt="image">
    </div>
    <div class="about-shape-4" data-speed="0.08" data-revert="true">
        <img src="{{asset('frontend/assets/images/about/shape-4.png')}}" alt="image">
    </div>
    <div class="about-shape-5" data-speed="0.08" data-revert="true">
        <img src="{{asset('frontend/assets/images/about/shape-5.png')}}" alt="image">
    </div>
...
<div class="team-area ptb-100">
    ...
    <div class="see-team-member-btn">
        <a href="#" class="see-btn">See Team Member</a>
    </div>
</div>
<!-- End Team Area -->
