...
<div class="ui-kit-cards grid mb-24">
    {{-- <h3>Complex</h3> --}}
    <form class="row g-3" class="row g-3" action="{{route('banniere.store')}}" method="POST">
        @csrf
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="subtitle" value="{{old('subtitle')}}" class="form-control" id="inputPassword4">
        </div>
        <div class="col-md-12">
