        ...
        <ul id="sidebar-menu" class="sidebar-menu">
            ...
            <li>
                <a href="#" class="has-arrow box-style">
                    ...
                    <span class="menu-title">Banniere</span>
                </a>

                <ul class="sidemenu-nav-second-level">
                    <li>
                        <a href="{{route('banniere.index')}}">
                            <span class="menu-title">Bannieres</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sidemenu-nav-second-level">
                    <li>
                        <a href="{{route('langage.index')}}">
                            <span class="menu-title">Langages</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="#" class="has-arrow box-style">
                    ...
                    <span class="menu-title">Realisation</span>
                </a>

                <ul class="sidemenu-nav-second-level">
                    <li>
                        <a href="{{route('realisation.index')}}">
                            <span class="menu-title">Realisations</span>
                        </a>
                    </li>
                </ul>
            </li>
