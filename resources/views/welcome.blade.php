        ...
        <div class="partner-box">
            <div class="partner-slides owl-carousel owl-theme">
                <div class="single-partner">
                    <a href="#"><img src="{{asset('frontend/assets/images/partner/partner-1.png')}}" alt="image"></a>
                </div>

                <div class="single-partner">
                    <a href="#"><img src="{{asset('frontend/assets/images/partner/partner-2.png')}}" alt="image"></a>
                </div>

                <div class="single-partner">
                    <a href="#"><img src="{{asset('frontend/assets/images/partner/partner-3.png')}}" alt="image"></a>
                </div>

                <div class="single-partner">
                    <a href="#"><img src="{{asset('frontend/assets/images/partner/partner-4.png')}}" alt="image"></a>
                </div>

                <div class="single-partner">
                    <a href="#"><img src="{{asset('frontend/assets/images/partner/partner-5.png')}}" alt="image"></a>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="cases-view-all-btn">
                <a href="case-study-1.html" class="default-btn">View All Projects <i class="ri-briefcase-line"></i><span></span></a>
            </div>
        </div>
    </div>
